...
def _revenue_sort_smallest_first(vnr_list: list) -> List[int]:
    """Greedy heuristic: sort by revenue ascending (smallest to biggest)."""
    return sorted(
        range(len(vnr_list)),
...
def hpso_embed_batch_greedy_smallest_first(
    ...
    from smallest revenue to biggest revenue.
    """
